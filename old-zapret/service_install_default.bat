...
:: Read selected file from default.txt if it exists
set "defaultFile=default.txt"
if exist "%defaultFile%" (
	set /p "selectedFile="<"%defaultFile%"
	if not exist "!selectedFile!" (
		echo Default file does not exist, please choose a new one.
		set "selectedFile="
	)
)
